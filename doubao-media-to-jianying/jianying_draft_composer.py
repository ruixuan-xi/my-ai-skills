...
def create_jianying_draft_with_media(draft_name, subtitle_texts, audio_paths, media_paths, draft_folder_path,
                                   ...
                                   mute_original_video=False, crop_video=False):
    """
    ...
    inputs:
        ...
        - add_video_movement (bool): 是否为视频添加随机运镜效果，默认True，eg: False
        - split_subtitles (bool): 是否将字幕拆分成短句，默认True，eg: True
        - mute_original_video (bool): 是否对原视频进行静音处理，默认False，eg: True
        - crop_video (bool): 是否对视频进行裁剪（音频短于视频时），默认False，eg: True
